    ...
    <div>
      ...
      <div className='flex flex-col justify-center gap-10 my-10 md:flex-row mb-28'>
        ...
        <div className='flex flex-col items-start justify-center gap-6'>
          ...
          <p className='text-gray-500'>Trendify 354 Fashion Lane <br />Kathmandu, Durbar Marg</p>
          <p className='text-gray-500'>Tel: (+977) 9810771153 <br />Email: chirayubaij@gmail.com</p>
